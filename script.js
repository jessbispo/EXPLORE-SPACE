...
let home = $('#home').click(()=>{ //ao clicar na pagina inicial, é redirecionado pra pagina inicial
    location.assign("index.html")
})

let linkedin = $('#linkedin').click(()=>{ //ao clicar na pagina inicial, é redirecionado pro meu linkedin
    location.assign("https://www.linkedin.com/in/j%C3%A9ssica-bispo-/")
})

let github = $('#github').click(()=>{ //ao clicar na pagina inicial, é redirecionado pro meu github
